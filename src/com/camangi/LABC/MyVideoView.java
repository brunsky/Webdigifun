 ...
 */
public class MyVideoView extends VideoView implements com.camangi.LABC.MyMediaController2.MediaPlayerControl {
    ...
    private MyMediaController2 mMediaController;
    ...
    public void setMediaController(MyMediaController2 controller) {
    ...
    private void attachMediaController() {
        if (mMediaPlayer != null && mMediaController != null) {
            mMediaController.setMediaPlayer2(this);
    ...
    private MediaPlayer.OnCompletionListener mCompletionListener =
        ...
        public void onCompletion(MediaPlayer mp) {
            ...
            if (mMediaController != null) {
            	// 重新載入撥放器以及內容
            	stopPlayback();
        		setVideoURI(Uri.parse("android.resource://" + mContext.getPackageName() + "/" + R.raw.story));
                mMediaController.show(0);
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        //mMediaController.showToast("view:"+Integer.toString(keyCode));
        if (isInPlaybackState() && isKeyCodeSupported && mMediaController != null) {
            if (keyCode == KeyEvent.KEYCODE_HEADSETHOOK ||
            	...
            	mMediaController.mRewListener.onClick(null);
            	
            } else if (keyCode == KeyEvent.KEYCODE_MEDIA_FAST_FORWARD) {
            	mMediaController.mFfwdListener.onClick(null);
            	
            } else {
            	if (keyCode != 165)
            		toggleMediaControlsVisiblity();
            	else {
            		mMediaController.shitCounter = -1;
            		mMediaController.show();
            		return true;
            	}
            }
